...
$query = mysqli_query($conn, "SELECT * FROM mental");
$result = [];
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="needs-validation" novalidate
                                            action="proses/proses_input_mental.php" method="POST">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingciri_ciri"
                                                            placeholder="ciri_ciri" name="ciri_ciri" required>
                                                        <label for="floatingKalori">Ciri-Ciri</label>
                                                        <div class="invalid-feedback">
                                                            Masukkan Ciri-Cirinya
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingefek"
                                                            placeholder="efek" name="efek" required>
                                                        <label for="floatingefek">Efek</label>
                                                        <div class="invalid-feedback">
                                                            Masukkan Efek
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatinglama"
                                                            placeholder="lama" name="lama" required>
                                                        <label for="floatinglama">Lama</label>
                                                        <div class="invalid-feedback">
                                                            Masukkan Hari
                                                        </div>
                                                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['ciri_ciri']); ?></td>
                                        <td><?php echo htmlspecialchars($row['efek']); ?></td>
                                        <td><?php echo htmlspecialchars($row['lama']); ?></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
