...
$query = mysqli_query($conn, "SELECT * FROM konseling");
$result = [];
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="needs-validation" novalidate
                                            action="proses/proses_input_konseling.php" method="POST">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control"
                                                            id="floatingpermasalahan" placeholder="permasalahan"
                                                            name="permasalahan" required>
                                                        <label for="floatingpermasalahan">Permasalahan</label>
                                                ...
                                                <div class="col">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingsolusi"
                                                            placeholder="solusi" name="solusi" required>
                                                        <label for="floatingsolusi">Solusi</label>
                                                        <div class="invalid-feedback">
                                                            Masukkan Solusi
                                                        </div>
                                                    </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['permasalahan']); ?></td>
